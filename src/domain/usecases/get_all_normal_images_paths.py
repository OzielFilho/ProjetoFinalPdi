...
class GetAllNormalImagesPathsAbstraction(ABC):
    @abstractmethod
...
class GetAllNormalImagesPaths(GetAllNormalImagesPathsAbstraction):
    def __init__(self, repository: ImageRepositoryAbstraction) -> None:
        self.repository = repository

    def __call__(self) -> Failure | list[str]:
        try:
            return self.repository.get_all_normal_images_paths()
